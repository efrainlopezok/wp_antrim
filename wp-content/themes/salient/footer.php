	...
	<?php } //endif for enable main footer area?>
		...
		<div class="row" id="copyright">
			...
			<?php if(!empty($options['disable-auto-copyright']) && $options['disable-auto-copyright'] == 1) { ?>
					...
					<?php } else { ?>
						<p>&copy; <?php echo date('Y') . ' ' . get_bloginfo('name'); ?>. <?php if(!empty($options['footer-copyright-text'])) echo $options['footer-copyright-text']; ?> 
					<?php } ?>
				<span class="right"><a href="/privacy" alt="Privacy Policy">Privacy Policy</a> </span></p>
				</div><!--/span_5-->
